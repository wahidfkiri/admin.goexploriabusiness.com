...
<div class="dashboard-content">
    ...
    <div class="page-header">
        ...
        <div class="page-actions">
            <a href="{{ route('cms.admin.pages.index', ['etablissementId' => $etablissement->id]) }}" class="btn btn-outline-secondary">
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        Swal.fire('Supprimée!', data.message, 'success').then(() => {
                            window.location.href = `/admin/cms/${etablissementId}/pages`;
                        });
                    } else {
                        Swal.fire('Erreur!', data.message, 'error');
                    }
